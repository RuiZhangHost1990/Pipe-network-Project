...
- Training data: FinalTrainData.csv (423 samples, read as Excel format)
- Split: 80% training / 20% validation with fixed seed=42
- CV: 10-fold cross-validation for all models
- Prediction: Predict.csv → InteractionCoe
...
df = pd.read_excel(r'C:\Users\Rui Zhang\Desktop\FinalTrainData.csv')
...
# ── 3. RealMLP — OPTIMIZED ═══════════════════════════════════════════════
# v3 had R2=0.437 (n_epochs=50 was too few). Fix: more epochs, deeper/wider.
...
# ── 4. TabM — OPTIMIZED ═════════════════════════════════════════════════
# v3 had R2=0.876 (n_epochs=50). Fix: more epochs, deeper architecture.
...
# ── 5. xRFM — OPTIMIZED ═════════════════════════════════════════════════
# v3 had R2=0.870 (only 1 tree). Fix: more iterations, auto bandwidth.
...
print(f"\n{'=' * 55}")
print("PREDICTION ON NEW DATA (Predict.csv)")
print(f"{'=' * 55}")

df_pred = pd.read_excel(r'C:\Users\Rui Zhang\Desktop\Finalcode\Predict.csv')
...
# Save
out_path = r'C:\Users\Rui Zhang\Desktop\Finalcode\Predict_with_predictions_v4.csv'
